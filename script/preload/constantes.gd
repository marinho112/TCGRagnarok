...
const GRUPO_AREA_FLUTUANTE="area_flutuante"
...
const GRUPO_AREA_CAMPO_TOTAL="grupo_area_campo_total"
...
const CARTA_ITEM=2
const CARTA_CONSUMIVEL=3
const CARTA_EQUIPAMENTO=4
const CARTA_MELHORIA=5
const CARTA_HABILIDADE=6
const CARTA_PASSIVA=7
const CARTA_EFEITO=8
